...
def get_player_input(expected_sequence, recorder, sound_gate=23):
    ...
    for i, expected_note in enumerate(expected_sequence):
        ...
        led4.off()
        led5.off()
        if expected_sequence.index(expected_note) % 5 == 1:
            led1.on()
        elif expected_sequence.index(expected_note) % 5 == 2:
            led2.on()
        elif expected_sequence.index(expected_note) % 5 == 3:
            led3.on()
        elif expected_sequence.index(expected_note) % 5 == 4:
            led4.on()
        else:
            led5.on()
